...
extension OffsetExtensions on Offset {
  ...
  ///
  /// This method scales the current offset coordinates (dx, dy) from the
  /// current device canvas size to a predefined standard canvas size.
  /// This is useful for maintaining consistency of coordinates across
  /// different devices.
  ///
  /// The scaling is based on the ratio of the standard canvas size to the
  /// actual size of the device canvas.
  ///
  ...
  /// Scales the current [Offset] from a standard canvas size to the device
  /// canvas size.
  ///
  /// This method is the inverse of [scaleToStandard]. It scales the current
  /// offset coordinates (dx, dy) from the standard canvas back to the device
  /// canvas size. This is particularly useful when rendering coordinates that
  /// were captured on a device with a different resolution.
  ///
  /// The scaling is based on the ratio of the device canvas size to the
